...
export class Elixir__soundResult {
  value0: BigInt;
  value1: BigInt;
  value2: string;
  value3: Address;
...
export class Elixir extends ethereum.SmartContract {
  ...
  licenses(): Array<BigInt> {
    let result = super.call("licenses", "licenses():(uint256[])", []);

    return result[0].toBigIntArray();
  }

  try_licenses(): ethereum.CallResult<Array<BigInt>> {
    let result = super.tryCall("licenses", "licenses():(uint256[])", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  sound(_tokenId: BigInt): Elixir__soundResult {
    let result = super.call(
      "sound",
    ...
    return new Elixir__soundResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toString(),
      result[3].toAddress()
  ...
  try_sound(_tokenId: BigInt): ethereum.CallResult<Elixir__soundResult> {
    let result = super.tryCall(
      "sound",
      "sound(uint256):(uint256,uint256,string,address)",
      [ethereum.Value.fromUnsignedBigInt(_tokenId)]
...
export class UpdatePriceMappingCall extends ethereum.Call {
  get inputs(): UpdatePriceMappingCall__Inputs {
    return new UpdatePriceMappingCall__Inputs(this);
  }

  get outputs(): UpdatePriceMappingCall__Outputs {
    return new UpdatePriceMappingCall__Outputs(this);
  }
}

export class UpdatePriceMappingCall__Inputs {
  _call: UpdatePriceMappingCall;

  constructor(call: UpdatePriceMappingCall) {
    this._call = call;
  }
...
export class UpdatePriceMappingCall__Outputs {
  _call: UpdatePriceMappingCall;
