...
export default function Hero() {
    return (
        ...
        >
            ...
            <NextLink href="/"><Button as="a" w="100%" h={{base: "100px", md: "200px"}} cursor="pointer" rounded="xl" fontSize="xl" bgGradient="linear(to-r, pink.400, pink.500)" _hover={{bg: "pink.300"}}>Popular</Button></NextLink>
